    ...
    <div className="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-left">
        ...
        {props.footerItem.map((item) => (
            ...
            <div className="text-xs uppercase text-gray-400 font-medium mb-6">
                ...
                {props.footerItems.get(item).map((item2)=>(
                    <a href={item2.href} className="my-3 block text-gray-300 hover:text-gray-100 text-sm font-medium duration-700">
                        {item2.text}
                    </a>
                ))}
            </div>      
        ...
        <div className="flex pb-5 px-3 m-auto pt-5 
            ...
            {props.footerIcon.map((itm) => (
                    ...
                    <a href={itm.href} className="w-6 mx-1">
                    <i className={itm.text}></i>
                </a>
